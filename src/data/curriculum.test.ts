...
describe('beginner curriculum scaffolding', () => {
  ...
  it('demystifies Java program scaffolding before asking the learner to edit it', () => {
    ...
    expect(guide).toContain('static lets Java call it without creating an object')
    expect(guide).toContain('void means it returns no answer')
    expect(guide).toContain('command-line text inputs')
