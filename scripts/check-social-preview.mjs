...
const image = await readFile(new URL('../public/social-card-v2.jpg', import.meta.url))

const requiredMetadata = [
  '<meta property="og:site_name" content="SeePoundCoffeePie" />',
  '<meta property="og:image" content="https://seepoundcoffeepie.com/social-card-v2.jpg" />',
  '<meta property="og:image:type" content="image/jpeg" />',
  '<meta property="og:image:width" content="1200" />',
  '<meta property="og:image:height" content="630" />',
  '<meta name="twitter:card" content="summary_large_image" />',
  '<meta name="twitter:image" content="https://seepoundcoffeepie.com/social-card-v2.jpg" />',
]
...
if (dimensions.width !== 1200 || dimensions.height !== 630) {
  throw new Error(`Expected social-card-v2.jpg to be 1200x630, received ${dimensions.width}x${dimensions.height}`)
}
